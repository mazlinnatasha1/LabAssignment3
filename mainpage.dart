...
import 'package:bookbytes/views/screens/bookdetails.dart';
...
//        ),
                            ...
                            children: [
                              Flexible(
                                ...
                                child: Container(
                                  ...
                                  child: Image.network(
                                      fit: BoxFit.fill,
                                      "${MyServerConfig.server}/bookbytes_v1/assets/books/${bookList[index].bookId}.png"),
                                ),
                              ),
                              Flexible(
                                flex: 4,
  ...
  void loadBooks(String title) {
    ...
    http
        .get(
      Uri.parse(
          "${MyServerConfig.server}/bookbytes_v1/php/load_books.php?title=$title&pageno=$curpage"),
    )
        .then((response) {
      log(response.body);
